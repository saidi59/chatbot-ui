...
AS $$
DECLARE
  project_url TEXT := 'https://azrsiswiginridvujbgx.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImF6cnNpc3dpZ2lucmlkdnVqYmd4Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczNjk0NzU3MSwiZXhwIjoyMDUyNTIzNTcxfQ.7ZAXMzQI4dLX4p_61CcL_p8xKjC0uJsfyezo0WsqwUU'; -- full access needed for http request to storage
